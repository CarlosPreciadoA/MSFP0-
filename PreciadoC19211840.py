...
Nombre del alumno: Carlos Samuel Preciado Amezquita
Número de control: C19211840
Correo institucional: lc19211840@tectijuana.edu.mx
...
def closedloop(t,sysPID,u):
    _,PIDu = ctrl.forced_response(sysPID,t,u,x0)   # <-- CORREGIDO: antes decía PAu
    return PIDu                                     # <-- CORREGIDO: antes decía PIDu (ya existe ahora)
